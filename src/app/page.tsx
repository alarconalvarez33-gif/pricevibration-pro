  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#0a0a0a]">
        ...
        <section className="relative pt-28 pb-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Link
                href="/quantum"
                className="bg-[#c9a227] hover:bg-[#d4af37] text-black px-8 py-4 rounded-xl text-lg font-bold transition-all"
              >
                Probar Calculadora Gratis
              </Link>
              <Link
                href="/advanced"
                className="border-2 border-gray-700 hover:border-[#c9a227]/50 text-white hover:text-[#c9a227] px-8 py-4 rounded-xl text-lg font-bold transition-all"
              >
            ...
            <div className="bg-[#1a1a2e] rounded-2xl p-8 md:p-12 border border-gray-800">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      <div key={item.n} className="flex gap-5">
                        <div className="w-12 h-12 bg-[#c9a227] rounded-xl flex items-center justify-center text-black font-bold text-xl shrink-0">
                          {item.n}
                        </div>
                        <div>
                ...
                <div className="bg-[#0a0a0a] rounded-xl p-6 border border-gray-800">
                  ...
                  <Link
                    href="/quantum"
                    className="block w-full mt-6 bg-[#c9a227] hover:bg-[#d4af37] text-black py-4 rounded-xl text-center font-bold transition-all"
                  >
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-[#1a1a2e] rounded-2xl overflow-hidden border border-purple-500/30 hover:border-purple-500/60 transition-all group">
                ...
                <div className="p-5">
                  <h3 className="text-lg font-bold text-white mb-1">Física Cuántica</h3>
              ...
              <div className="bg-[#1a1a2e] rounded-2xl overflow-hidden border border-gray-800 hover:border-[#c9a227]/50 transition-all group">
                ...
                <div className="p-5">
                  <h3 className="text-lg font-bold text-white mb-1">Canal Paralelo</h3>
              ...
              <div className="bg-[#1a1a2e] rounded-2xl overflow-hidden border border-gray-800 hover:border-green-500/50 transition-all group">
                ...
                <div className="p-5">
                  <h3 className="text-lg font-bold text-white mb-1">Fibonacci Avanzado</h3>
              ...
              <div className="bg-[#1a1a2e] rounded-2xl overflow-hidden border border-rose-500/30 hover:border-rose-500/60 transition-all group">
                ...
                <div className="p-5">
                  <h3 className="text-lg font-bold text-white mb-1">Expansión Matemática</h3>
        ...
        {/* ── PRICING - CON IMÁGENES DE PLANES ─────────────────── */}
        <section className="py-20 px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-[#1a1a2e] rounded-2xl overflow-hidden border-2 border-[#c9a227]/50 relative">
                ...
                <div className="relative h-36 overflow-hidden">
                  <Image src="/planpro.png" alt="Plan Pro" fill className="object-cover" />
                </div>
              ...
              <div className="bg-[#1a1a2e] rounded-2xl overflow-hidden border border-purple-500/30">
                <div className="relative h-36 overflow-hidden">
                  <Image src="/whale.png" alt="Plan Whale" fill className="object-cover" />
            ...
            <div className="mt-12 bg-[#1a1a2e] rounded-2xl p-8 border border-gray-800">
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                {[
                  { cuotas: '3 cuotas', label: 'Sin interés', color: 'text-green-400', border: 'border-gray-800' },
                  { cuotas: '6 cuotas', label: 'Sin interés', color: 'text-green-400', border: 'border-gray-800' },
                  { cuotas: '12 cuotas', label: 'Sin interés', color: 'text-[#c9a227]', border: 'border-[#c9a227]/50' },
                ].map((item) => (
                  <div key={item.cuotas} className={`bg-[#0a0a0a] rounded-xl p-4 border ${item.border}`}>
                    <p className="text-white font-bold">{item.cuotas}</p>
        ...
        <section className="py-20 px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link
              href="/quantum"
              className="inline-block bg-[#c9a227] hover:bg-[#d4af37] text-black px-10 py-4 rounded-xl text-lg font-bold transition-all"
            >
              Probar Calculadora Gratis
            </Link>
          </div>

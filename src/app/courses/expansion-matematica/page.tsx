...
export default async function ExpansionMatematicaPage() {
  ...
  if (!vip) {
    const paid = await prisma.productPurchase.findFirst({
      where: { userId: user.id, productId: 'expansion-matematica', status: 'paid' },
    })
    hasPurchased = !!paid

    if (!hasPurchased) {
      const pending = await prisma.productPurchase.findFirst({
        where: { userId: user.id, productId: 'expansion-matematica', status: 'pending' },
      ...
      <div className="border-b border-[#c9a227]/20 bg-[#0a0a0f]/95 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-white">Genesis</h1>
      ...
      {hasAccess ? (
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <div className="mb-8 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-3">Genesis</h2>
        ...
        <div className="max-w-2xl mx-auto px-4 py-24 text-center">
          ...
          <p className="text-gray-500 text-sm mb-8">
            <span className="text-[#c9a227] font-semibold">Genesis</span> — acceso único por{' '}

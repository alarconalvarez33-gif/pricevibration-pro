...
export const metadata: Metadata = {
  title: 'Terminal de niveles',
  description:
    'Los seis niveles del día por activo, precios en vivo, calculadora de riesgo y alertas cuando el precio toca un nivel.',
};
...
export default async function TerminalPage() {
  ...
  // Render the first snapshot server-side. Without this the terminal painted
  // every price slot as "—" and only filled in after the JS bundle downloaded,
  // hydrated, and a client fetch resolved — several seconds on mobile, which

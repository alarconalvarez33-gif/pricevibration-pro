...
export function WhatsAppButton({
  ...
  if (variant === 'icon-only') {
    return (
      <a
        ...
        className={`inline-flex items-center justify-center w-10 h-10 rounded-full bg-green-500 hover:bg-green-400 text-white transition-colors ${className}`}
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-green-500 hover:bg-green-400 text-white font-medium transition-colors ${className}`}
    >
      <WhatsAppIcon />
      <span>{label}</span>
    </a>
